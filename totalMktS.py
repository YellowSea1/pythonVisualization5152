...
def totalMktS():
    category = ['Consumer', 'Home Office', 'Corporate']
    sell = [19226, 6667, 11480]
    avgProfit = [7.52, 9.13, 7.98]
    ...
    c = (
        Pie(init_opts=opts.InitOpts(theme=ThemeType.MACARONS, width="1200px", height="400px", ))
            ...
            .set_global_opts(title_opts=opts.TitleOpts(title="总细分市场统计（销售量与平均利润）", subtitle="扇区圆心角展现数据百分比，半径展现数据大小"),
